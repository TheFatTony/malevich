...
const routes: Routes = [
...

  {
    path: 'profile', canActivate: [AuthGuard], canActivateChild: [KycGuard], children: [
      ...
      {path: 'orders', component: ProfileOrdersComponent, data: {kycLevels: ['T_TIER1', 'G_TIER1']}, canActivate: [AuthGuard]},
      {path: 'artworks', component: ProfileArtworkStockComponent, data: {kycLevels: ['T_TIER1', 'G_TIER1']}, canActivate: [AuthGuard]},
